      ...
      <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start bg-white bg-opacity-60">
        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div className="py-12 sm:py-16 lg:py-20">
            ...
            <div className="my-6 text-gray-900 space-y-6 font-medium">
              ...
              <p className="text-base leading-7">
                In the Summer of 2015 ARYSON!CK went to Las Vegas, NV for a trip, it was then, where he saw Calvin Harris and got inspired to start DJing. ARYSONICK started DJing graduation parties, events, and weddings on the side.
              </p>
              <p className="text-base leading-7">
                ARYSON!CK wanted to take his passion and love for music production and DJing to the next level. That's why he is currently attending Recording Radio Film Connection.
              </p>
            </div>
          </div>
        </div>
